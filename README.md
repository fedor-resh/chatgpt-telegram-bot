...
docker run -it --env-file .env.example n3d1117/chatgpt-telegram-bot
```
...
docker run -it --env-file .env.example ghcr.io/n3d1117/chatgpt-telegram-bot
```

#### Docker manual build
```shell
docker build -t chatgpt-telegram-bot .
docker run -it --env-file .env.example chatgpt-telegram-bot
```
